...
// .svelte-kit/output/server/chunks/index-b63db954.js
function noop2() {
}
function run(fn) {
  return fn();
...
// .svelte-kit/output/server/chunks/store-5dd80059.js
...
var subscriber_queue2, dark, title, path;
var init_store_5dd80059 = __esm({
  ".svelte-kit/output/server/chunks/store-5dd80059.js"() {
    init_index_b63db954();
    subscriber_queue2 = [];
    dark = writable2(true);
    title = writable2("");
    path = writable2("/home/scythe");
  }
});
...
var SideHierarchy, SideCategory, SideFile, Side, Navbar, NavbarTitle, Nav, _layout;
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/__layout.svelte.js"() {
    init_index_b63db954();
    init_store_5dd80059();
    SideHierarchy = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { class: className } = $$props;
      if ($$props.class === void 0 && $$bindings.class && className !== void 0)
        $$bindings.class(className);
      return `<div class="${escape(className) + " h-full w-64 dark:bg-primary-dark-90 pl-6 pt-6"}">${slots.default ? slots.default({}) : ``}</div>`;
    });
    SideCategory = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $dark, $$unsubscribe_dark;
      $$unsubscribe_dark = subscribe(dark, (value) => $dark = value);
      $$unsubscribe_dark();
      return `<div><div class="${"flex flex-row cursor-pointer select-none"}">${`<svg width="${"24"}" height="${"24"}" viewBox="${"0 0 24 24"}" fill="${"none"}" xmlns="${"http://www.w3.org/2000/svg"}"><path d="${"M12 15.713L18.01 9.70299L16.597 8.28799L12 12.888L7.40399 8.28799L5.98999 9.70199L12 15.713Z"}"${add_attribute("fill", $dark ? "#FFFFFF" : "#2E3A59", 0)}></path></svg>`}
        <h5 class="${"dark:text-white"}">Recents</h5></div>
    <div${add_attribute("class", "block", 0)}>${slots.default ? slots.default({}) : ``}</div></div>`;
    });
    SideFile = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $dark, $$unsubscribe_dark;
      $$unsubscribe_dark = subscribe(dark, (value) => $dark = value);
      let { name } = $$props;
      if ($$props.name === void 0 && $$bindings.name && name !== void 0)
        $$bindings.name(name);
      $$unsubscribe_dark();
      return `<div class="${"ml-3 flex flex-row mt-1 items-center cursor-pointer select-none"}">${`<svg width="${"20"}" height="${"20"}" viewBox="${"0 0 24 24"}" fill="${"none"}" xmlns="${"http://www.w3.org/2000/svg"}"><path d="${"M18 22H6C4.89543 22 4 21.1046 4 20V4C4 2.89543 4.89543 2 6 2H13C13.0109 2.00047 13.0217 2.00249 13.032 2.006C13.0418 2.00902 13.0518 2.01103 13.062 2.012C13.1502 2.01765 13.2373 2.0348 13.321 2.063L13.349 2.072C13.3717 2.07968 13.3937 2.08904 13.415 2.1C13.5239 2.14842 13.6232 2.21618 13.708 2.3L19.708 8.3C19.7918 8.38479 19.8596 8.48406 19.908 8.593C19.918 8.615 19.925 8.638 19.933 8.661L19.942 8.687C19.9699 8.77039 19.9864 8.85718 19.991 8.945C19.9926 8.95418 19.9949 8.96322 19.998 8.972C19.9998 8.98122 20.0004 8.99062 20.0001 9V20C20.0001 21.1046 19.1046 22 18 22ZM6 4V20H18V10H13C12.4477 10 12 9.55228 12 9V4H6ZM14 5.414V8H16.586L14 5.414Z"}"${add_attribute("fill", $dark ? "#FFFFFF" : "#2E3A59", 0)}></path></svg>`}

    <h1 class="${"dark:text-white ml-1 " + escape("")}">${escape(name)}</h1></div>`;
    });
    Side = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { ifIsHidden } = $$props;
      if ($$props.ifIsHidden === void 0 && $$bindings.ifIsHidden && ifIsHidden !== void 0)
        $$bindings.ifIsHidden(ifIsHidden);
      return `${validate_component(SideHierarchy, "SideHierarchy").$$render($$result, { class: "shrink-0 hidden " + ifIsHidden }, {}, {
        default: () => {
          return `${validate_component(SideCategory, "SideCategory").$$render($$result, {}, {}, {
            default: () => {
              return `${validate_component(SideFile, "SideFile").$$render($$result, { name: "README.md" }, {}, {})}
        ${validate_component(SideFile, "SideFile").$$render($$result, { name: "main.go" }, {}, {})}`;
            }
          })}`;
        }
      })}`;
    ...
    Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<nav class="${"dark:bg-primary-dark-100 h-16 w-full flex justify-between items-center"}"><div>${slots.title ? slots.title({}) : ``}</div>
    ${slots.path ? slots.path({}) : ``}
    <div><img src="${""}" alt="${""}">
        <img src="${""}" alt="${""}">
        <img src="${""}" alt="${""}"></div></nav>`;
    });
    NavbarTitle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $dark, $$unsubscribe_dark;
      $$unsubscribe_dark = subscribe(dark, (value) => $dark = value);
      let { content } = $$props;
    ...
    Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      let { onClickingEvent } = $$props;
      if ($$props.onClickingEvent === void 0 && $$bindings.onClickingEvent && onClickingEvent !== void 0)
        $$bindings.onClickingEvent(onClickingEvent);
      $$unsubscribe_path();
      $$unsubscribe_title();
      return `${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
        path: () => {
          return `<h3 slot="${"path"}" class="${"text-primary-dark-10"}">${escape($path)}</h3>`;
        },
        title: () => {
          return `${validate_component(NavbarTitle, "NavbarTitle").$$render($$result, { content: $title, slot: "title" }, {}, {})}`;
        },
        default: () => {
    ...
    _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      let isHidden = true;
      $$unsubscribe_dark();
      return `<main class="${"sm:h-screen " + escape($dark ? "dark" : "")}">${``}
    ${validate_component(Nav, "Nav").$$render($$result, {
        onClickingEvent: () => isHidden = !isHidden
      }, {}, {})}
    <div class="${"h-full flex-row flex md:max-h-[93vh]"}">${validate_component(Side, "Side").$$render($$result, {
        ifIsHidden: isHidden ? "hidden" : "md:block"
      }, {}, {})}
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    entry = "pages/__layout.svelte-0f14362d.js";
    js = ["pages/__layout.svelte-0f14362d.js", "chunks/index-8d015e40.js", "chunks/store-9ca3b9b3.js", "chunks/index-dc17940a.js"];
    css = ["assets/pages/__layout.svelte-a5bcbd86.css"];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    entry2 = "error.svelte-2bef9c40.js";
    js2 = ["error.svelte-2bef9c40.js", "chunks/index-8d015e40.js"];
    css2 = [];
  }
});
...
var init_index_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/index.svelte.js"() {
    init_index_b63db954();
    init_store_5dd80059();
    Directory = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $dark, $$unsubscribe_dark;
      $$unsubscribe_dark = subscribe(dark, (value) => $dark = value);
      let { data } = $$props;
      if ($$props.data === void 0 && $$bindings.data && data !== void 0)
        $$bindings.data(data);
      $$unsubscribe_dark();
      return `<a class="${"transition-all dark:bg-primary-dark-100 flex flex-col items-center justify-center p-4 max-w-[11rem] min-w-[11rem] rounded-xl hover:shadow-md shadow-primary-dark-10"}" href="${"/" + escape(data)}"><svg width="${"144"}" height="${"144"}" viewBox="${"0 0 24 24"}" fill="${"none"}" xmlns="${"http://www.w3.org/2000/svg"}"><path d="${"M20 21H4C2.89543 21 2 20.1046 2 19V5C2 3.89543 2.89543 3 4 3H10C10.2652 3 10.5195 3.10545 10.707 3.293L12.414 5H20C21.1046 5 22 5.89543 22 7V19C22 20.1046 21.1046 21 20 21ZM4 7V19H20V7H4Z"}"${add_attribute("fill", $dark ? "#ADADAD" : "#2E3A59", 0)}></path></svg>
    <h5 class="${"dark:text-white text-black"}">${escape(data)}</h5></a>`;
    });
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      title.set("Explorer");
      let routes = ["projects", "whoami", "b_chain", "skills"];
      return `<section class="${"w-full h-full dark:bg-primary-dark-100 flex justify-center items-center p-4"}"><div class="${"rounded-lg dark:bg-primary-dark-90 border border-primary-dark-60 w-full h-full p-8 flex sm:sm:flex justify-center sm:justify-start sm:items-start"}"><div class="${"grid gap-12 w-fit lg:grid-cols-4s lg:grid-rows-1s md:grid-cols-3s md:grid-rows-2s sm:grid-cols-2s grid-cols-1s grid-rows-4s"}">${each(routes, (route) => {
        return `${validate_component(Directory, "Directory").$$render($$result, { data: route }, {}, {})}`;
      })}</div></div></section>`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    init_index_svelte();
    entry3 = "pages/index.svelte-fa0372e2.js";
    js3 = ["pages/index.svelte-fa0372e2.js", "chunks/index-8d015e40.js", "chunks/store-9ca3b9b3.js", "chunks/index-dc17940a.js"];
    css3 = [];
  }
});

// .svelte-kit/output/server/entries/pages/whoami.svelte.js
var whoami_svelte_exports = {};
__export(whoami_svelte_exports, {
  default: () => Whoami
});
var Whoami;
var init_whoami_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/whoami.svelte.js"() {
    init_index_b63db954();
    init_store_5dd80059();
    Whoami = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      title.set("Who am I?");
      return ``;
    });
  }
...
__export(__exports4, {
  ...
  entry: () => entry4,
  js: () => js4,
  module: () => whoami_svelte_exports
});
var entry4, js4, css4;
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    init_whoami_svelte();
    entry4 = "pages/whoami.svelte-47d5b13a.js";
    js4 = ["pages/whoami.svelte-47d5b13a.js", "chunks/index-8d015e40.js", "chunks/store-9ca3b9b3.js", "chunks/index-dc17940a.js"];
    css4 = [];
  }
});
...
var manifest = {
  ...
  mimeTypes: {},
  _: {
    entry: { "file": "start-c460f610.js", "js": ["start-c460f610.js", "chunks/index-8d015e40.js", "chunks/index-dc17940a.js"], "css": [] },
    nodes: [
